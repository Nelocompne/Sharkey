...
import { setFavIconDot } from '@/scripts/icon-dot.js';
...
if ($i) {
	...
	watch(
		() => $i != null && $i.hasUnreadNotification,
		() => setFavIconDot(defaultStore.state.enableFaviconNotificationDot ? $i.hasUnreadNotification : false ),
	);
